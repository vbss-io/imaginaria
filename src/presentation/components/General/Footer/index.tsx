...
export const Footer = () => {
  return (
    <S.Container>
      ...
      <S.ContactContainer>
        <Button size="icon-md" rounded="full" onClick={() => window.open('https://vbss.io', '_blank')}>
          <Globe color="white" width="1.3rem" height="1.3rem" />
        </Button>
        <Button size="icon-md" rounded="full" onClick={() => window.open('https://github.com/vbss-io', '_blank')}>
